...
##License
Starting with v1.0b the controller is released under the MIT license, though upgraders from the ZUUIRevealController are free to keep using the BSD clause 3.
